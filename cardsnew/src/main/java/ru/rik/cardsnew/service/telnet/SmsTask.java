...
public class SmsTask implements MyState {
	...
	@Builder
	public SmsTask(Channel ch, Channel pair, TelnetClient telnetClient, List<Sms> allsms, Phase phase) {
		super();
		this.ch = ch;
		this.pair = pair;
	...
	public static SmsTask get(TelnetHelper h, Channel ch, Channel pair) throws SocketException, IOException {
