...
public class BankRepoTest {
	...
	public void loadData() {
		...
		Bank b2 = new Bank(2, 1, "2", "1.1.1.2",  null, null);
		repo.addStateIfAbsent(b2);
		list.add(b2);
		
		Bank b3 = new Bank(3, 1, "3", "1.1.1.3",  null, null);
		repo.addStateIfAbsent(b3);
		list.add(b3);
		
		Bank b4 = new Bank(4, 1, "4", "1.1.1.4",  null, null);
		repo.addStateIfAbsent(b4);
		list.add(b4);
		
		Bank b5 =new Bank(5, 1, "5", "1.1.1.5",  null, null);
