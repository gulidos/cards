...
public class ChannelRepoTest {
	...
	private void initData() {
		...
		Channel ch = new Channel(1, 1, "ch1", Line.L1, box, null, new HashSet<Trunk>(Arrays.asList(t)), new Card(),	true);
		s.add(ch);
		ChannelState st = repo.addStateIfAbsent(ch);
		st.setStatus(Status.Ready);
		
		ch = new Channel(2, 1, "ch2", Line.L2, box, null, new HashSet<Trunk>(Arrays.asList(t)), new Card(), true);
		s.add(ch);
		st = repo.addStateIfAbsent(ch);
		st.setStatus(Status.Ready);
		
		ch = new Channel(3, 1, "ch3", Line.L3, box, null, new HashSet<Trunk>(Arrays.asList(t)), new Card(), true);
		s.add(ch);
		st = repo.addStateIfAbsent(ch);
		st.setStatus(Status.Ready);
		
		ch = new Channel(4, 1, "ch4", Line.L4, box, null, new HashSet<Trunk>(Arrays.asList(t)), new Card(), true);
		s.add(ch);
		st = repo.addStateIfAbsent(ch);
		st.setStatus(Status.Ready);
		
		ch = new Channel(5, 1, "ch5", Line.L5, box, null, new HashSet<Trunk>(Arrays.asList(t)), new Card(), true);
		s.add(ch);
		st = repo.addStateIfAbsent(ch);
		st.setStatus(Status.Ready);
		
		ch = new Channel(6, 1, "ch6", Line.L6, box, null, new HashSet<Trunk>(Arrays.asList(t)), new Card(), true);
		s.add(ch);
		st = repo.addStateIfAbsent(ch);
		st.setStatus(Status.Ready);
		
		ch = new Channel(7, 1, "ch7", Line.L7, box, null, new HashSet<Trunk>(Arrays.asList(t)), new Card(), true);
		s.add(ch);
		st = repo.addStateIfAbsent(ch);
		st.setStatus(Status.Ready);
		
		ch = new Channel(8, 1, "ch8", Line.L8, box, null, new HashSet<Trunk>(Arrays.asList(t)), new Card(), true);
		s.add(ch);
		st = repo.addStateIfAbsent(ch);
		st.setStatus(Status.Ready);
